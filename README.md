...
Using Jupyter notebooks, I began analyzing data from the NHIS set and used pandas to manipulate it. <br>See: [Social Determinants in Health](/determinants.md) (still in progress)
